...
// Only start the HTTP server if this file is executed directly via `node`.
// When imported (e.g. in tests), export the Express app without listening.
...
// Export the app for testing purposes. CommonJS default export allows
// `import app from './server.js'` in ES module contexts.
module.exports = app;
// KL12 Add routes
